...
selection = st.sidebar.radio("Go to", ["Home", "Predictive Model", "Power BI Dashboard", "Feedback"])
...
if st.session_state.page == "Home":
    # Title and Subtitle
    st.title("Predicting Pneumonia Mortality in New York City")
    st.subheader("Advanced Data Science for Informed Healthcare Decisions")

    # Brief Introduction
    st.write("""
    Leveraging cutting-edge machine learning models to predict pneumonia outcomes, this tool empowers healthcare providers 
    with actionable insights to improve patient care and reduce mortality.
    """)

    # Key Features or Benefits
    st.write("### Key Features:")
    st.write("- Early identification of high-risk patients.")
    st.write("- Evidence-based decision support.")
    st.write("- Integration with existing healthcare workflows.")


    # Contact Information or Footer
    st.write("### For more information or collaboration opportunities:")
    st.markdown("[Predicting Pneumonia Mortality Report](https://docs.google.com/document/d/1awscu2Q0PF9B_5sX1x8_WHzAWD6K3eWqhMKaqPK6-gE/edit?usp=sharing)", unsafe_allow_html=True)


    # Navigation buttons
    #if st.button("Go to Predictive Model"):
        #st.session_state.page = "Prediction Model"

    #elif st.button("Go to Power BI Dashboard"):
        #st.session_state.page = "Power BI Dashboard"
    ...
    if st.button("Predict"):
        ...
        st.write(f"Prediction Probabilities: {dict(zip(labels, prediction_prob[0]))}")

elif st.session_state.page == "Power BI Dashboard":
    st.title("Power BI Dashboard")
    st.markdown("View the interactive Power BI dashboard below.")
